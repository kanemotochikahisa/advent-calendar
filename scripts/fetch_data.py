...
print("internal calendar.json updated")
...
with open("external/data/calendar.json", "w", encoding="utf-8") as f:
    json.dump(external_data, f, ensure_ascii=False, indent=2)

print("external calendar.json updated")
